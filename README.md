...
RF06	Equilíbrio de Postos	A lógica de geração deve buscar um equilíbrio na alocação, garantindo que os funcionários sejam distribuídos de forma justa pelos postos ao longo do tempo
                               (evitando que o mesmo funcionário fique sempre no mesmo posto ou nos postos mais/menos prioritários).
